...
This file places events before prose. Dates remain blank until Steven confirms them or a public record supports them.
...
| TBD | First use of FYP.Lovely or Miss Lovely |  |  |  | platform record / testimony | pending |
| TBD | Start of A Lovely Breakdown |  |  |  | platform record / testimony | pending |
| TBD | SoCreate begins |  |  |  | repository / testimony | pending |
| TBD | Nexus Canvas begins |  |  |  | repository / testimony | pending |
| TBD | InkFrame begins |  |  |  | repository / testimony | pending |
| TBD | The Glass Horizon begins |  |  |  | repository / testimony | pending |
| TBD | First public research repository |  |  |  | repository | pending |
| TBD | The SoQuarky System is organized |  |  |  | repository | pending |
| TBD | Life OS is organized |  |  |  | author record | pending |

## Scene-detail checklist

For each event, record:

- the exact or approximate date
- the physical location
- what Steven could see, hear, hold, or operate
- the action Steven took
- what another person actually said, only when remembered or recorded
- what changed immediately afterward
- what evidence exists
- whether the event is approved for public use
